...
describe('Produto Use case', () => {
  ...
  beforeEach(async () => {
    ...
    produtoRepository =
      module.get<IProdutoRepository>(IProdutoRepository);
    produtoFactory =
      module.get<IProdutoFactory>(IProdutoFactory);
    categoriaRepository =
  ...
  describe('Criar produto', () => {
    ...
    it('Deve ser lançado um erro ao tentar criar um produto com um nome já registrado no sistema', async () => {
      ...
      const produtoDTO = makeCriaProdutoDTO('Produto X', 'Teste Produto X', 5.0, 'http://', '0a14aa4e-75e7-405f-8301-81f60646c93d');
      ...
      expect(
        produtoUseCase.criarProduto(produtoDTO)
      ).rejects.toThrow(
  ...
  describe('Editar produto', () => {
    ...
    it('Deve ser possível editar um produto', async () => {
      ...
      const result = await produtoUseCase.editarProduto(produtoAtualizadaModelMock.id, atualizaProdutoDto);
    ...
    describe('Excluir produto', () => {
      ...
      it('Deve ser possível excluir um produto', async () => {
        ...
        const result = await produtoUseCase.excluirProduto(produtoAtualizadaModelMock.id);
    ...
    describe('Buscar Produto', () => {
      ...
      it('Deve ser possível buscar um produto por ID', async () => {
        ...
        const result = await produtoUseCase.buscarProduto(produtoAtualizadaModelMock.id)
