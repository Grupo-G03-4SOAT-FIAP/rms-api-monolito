...
export interface IProdutoFactory {
  criarEntidadeProdutoFromCriaProdutoDTO(categoria: CategoriaModel, criaProdutoDTO: CriaProdutoDTO): Promise<ProdutoEntity>;
  criarEntidadeProdutoFromAtualizaProdutoDTO(categoria: CategoriaModel, atualizaProdutoDTO: AtualizaProdutoDTO): Promise<ProdutoEntity>
}
